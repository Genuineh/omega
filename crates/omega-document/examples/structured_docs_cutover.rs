...
use omega_document::{DocumentMutationMode, OmegaDocument, StructuredDocsValidationReport};
...
fn main() -> Result<()> {
    ...
    let result = documents.run_structured_docs_cutover(DocumentMutationMode::Apply, sources, None)?;
