...
| Command system and document knowledge | `docs/specs/omega-command-system.md`, `docs/specs/omega-project-system.md`, `docs/specs/omega-context-management.md`, `docs/specs/omega-tui-document-memory-supervision.md` |
